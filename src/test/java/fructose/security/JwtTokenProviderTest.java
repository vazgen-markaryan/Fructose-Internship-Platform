...
class JwtTokenProviderTest {
	...
	public void test_handle_invalid_jwt_signature() {
		String token = "valid.token"; // Simuler un token valide

		// Simuler une SecurityException lors de la validation du token
		JwtParser parser = Mockito.mock(JwtParser.class);
		Mockito.when(parser.setSigningKey((byte[]) Mockito.any())).thenThrow(new SecurityException("Invalid signature"));
