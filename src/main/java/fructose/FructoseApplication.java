...
public class FructoseApplication implements CommandLineRunner {
	...
	public void run(String... args) {
		...
		// OFFRES DE STAGE
		createAndPersistOffreStage("Développeur Java", "Développer des applications Java", "Développeur Java", "Ubisoft Incorporé", departementInformatique, 20.0, "présentiel", "5505, rue Saint-Laurent, Montréal, QC, H2T 1S6", "temps_partiel", LocalDate.of(2025, 6, 1), LocalDate.of(2025, 8, 31), 20, 5, LocalDate.of(2025, 5, 1), "ubisoft@gmail.com");
		...
		createAndPersistOffreStage("Développeur Python", "Développer des applications Python", "Développeur Python", "Ubisoft Incorporé", departementInformatique, 22.0, "présentiel", "Redmond, Washington, États-Unis", "temps_partiel", LocalDate.of(2025, 6, 1), LocalDate.of(2025, 8, 31), 25, 8, LocalDate.of(2025, 5, 1), "ubisoft@gmail.com");
		...
		createAndPersistOffreStage("Développeur Go", "Développer des applications Go", "Développeur Go", "Ubisoft Incorporé", departementInformatique, 28.0, "présentiel", "Stockholm, Suède", "temps_plein", LocalDate.of(2025, 6, 1), LocalDate.of(2025, 8, 31), 19, 8, LocalDate.of(2025, 5, 1), "ubisoft@gmail.com");
		...
		createAndPersistOffreStage("Ingénieur DevOps", "Gérer l'infrastructure", "Ingénieur DevOps", "Google LLC", departementInformatique, 26.0, "présentiel", "Armonk, New York, États-Unis", "temps_plein", LocalDate.of(2025, 6, 1), LocalDate.of(2025, 8, 31), 15, 7, LocalDate.of(2025, 5, 1), "google@gmail.com");
		...
		createAndPersistOffreStage("Testeur QA", "Tester des applications", "Testeur QA", "Google LLC", departementInformatique, 21.0, "présentiel", "San Francisco, Californie, États-Unis", "temps_partiel", LocalDate.of(2025, 6, 1), LocalDate.of(2025, 8, 31), 19, 8, LocalDate.of(2025, 5, 1), "google@gmail.com");
		createAndPersistOffreStage("Développeur Kotlin", "Développer des applications Android", "Développeur Kotlin", "Google LLC", departementInformatique, 31.0, "présentiel", "Mountain View, Californie, États-Unis", "temps_partiel", LocalDate.of(2025, 6, 1), LocalDate.of(2025, 8, 31), 20, 8, LocalDate.of(2025, 5, 1), "google@gmail.com");
		...
		createAndPersistOffreStage("Consultant en IT", "Conseiller les entreprises sur les technologies", "Consultant IT", "Google LLC", departementInformatique, 32.0, "présentiel", "New York, New York, États-Unis", "temps_plein", LocalDate.of(2025, 6, 1), LocalDate.of(2025, 8, 31), 22, 9, LocalDate.of(2025, 5, 1), "google@gmail.com");
		...
		createAndPersistOffreStage("Analyste en cybersécurité", "Protéger les données", "Analyste Cyber", "Activision Publishing, Inc", departementInformatique, 37.0, "présentiel", "Santa Clara, Californie, États-Unis", "temps_partiel", LocalDate.of(2025, 6, 1), LocalDate.of(2025, 8, 31), 16, 8, LocalDate.of(2025, 5, 1), "activision@gmail.com");
		...
		createAndPersistOffreStage("Développeur .NET", "Développer des applications .NET", "Développeur .NET", "Activision Publishing, Inc", departementInformatique, 30.0, "présentiel", "San Francisco, Californie, États-Unis", "temps_partiel", LocalDate.of(2025, 6, 1), LocalDate.of(2025, 8, 31), 21, 5, LocalDate.of(2025, 5, 1), "activision@gmail.com");
	}
