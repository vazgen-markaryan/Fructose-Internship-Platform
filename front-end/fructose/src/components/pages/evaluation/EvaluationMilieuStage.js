...
const EvaluationMilieuStage = () => {
    ...
    }, [currentUser, fetchCandidatureByEtatContratSigneTous]);
        ...
        return (
            <section>
                <div className="toolbar-items">
                    <h4 className="m-0 toolbar-spacer">{t("evaluation_milieu-stage.milieu-stage_a_evaluer")}</h4>
                </div>
                <div style={{padding: "10px 0"}}>
                    {candidatures.length === 0 ? (
                        <div className="toolbar-items">
                            <p className="m-0">{t("evaluation_milieu-stage.no_milieu-stage_a_evaluer")}</p>
                        </div>
                    ) : (
                        <div
                            className="menu-list"
                                        ...
                                        {isButtonEnabled(candidature.candidature.offreStageDTO.dateFin) ? (
                                            <>
                                                <p style={{margin: 0, color: "green"}}>
                                                    {t("evaluation_milieu-stage.evaluation_disponible")}
                                                </p>
                                                <button
                                                ...
                                                >
                                                    {t("evaluation_milieu-stage.evaluer")}
                                            ...
                                            <>
                                                <p style={{margin: 0, color: "red"}}>
                                                    {t("evaluation_milieu-stage.evaluation_non_disponible")} (
                                                    {new Date(
                                                        new Date(
    ...
    if (currentUser?.role === "ADMIN") {
        ...
        return (
            <section>
                <div className="toolbar-items">
                    <h4>{t("dashboard_home_page.manage_evaluations_milieu-stage")}</h4>
                </div>
                <div style={{padding: "10px 0"}}>
                    {evaluation.length === 0 ? (
                        <div
                        ...
                        >
                            ...
                            <p>{t("dashboard_home_page.no_evaluation_milieu-stage")}</p>
                        </div>
                    ) : (
                        <div
                            style={{
