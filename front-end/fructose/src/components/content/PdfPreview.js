...
const PdfPreview = ({ file, height = 500 }) => {
    ...
    return (
        <div className={`pdf-file-preview-zone ${isFullScreen ? 'fullscreen' : ''}`} style={{ height: isFullScreen ? '80vh' : height + 'px', width: 'auto', overflow: 'hidden', overflowX: 'hidden' }}>
            <button onClick={toggleFullScreen} className="fullscreen-toggle" style={{ position: 'absolute', top: '10px', right: '10px', zIndex: 10 }}>
